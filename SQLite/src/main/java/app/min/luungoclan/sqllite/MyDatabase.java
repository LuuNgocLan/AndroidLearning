...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    private static final String ADDRESS ="Contact_Address";
    ...
    public int updateContact(Contact contact){
        ...
        contentValues.put(DATE,contact.getmDate());
        contentValues.put(TIME,contact.getmTime());
        contentValues.put(GENDER,contact.getmGender());
